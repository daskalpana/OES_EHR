...
write.csv(results, file = paste0("Outputs/Output1_case9/", i, ".csv"), row.names = FALSE)
write.csv(bias_qua, file = paste0("Outputs/Output2_case9/", i, ".csv"), row.names = FALSE)
write.csv(valid_stats, file = paste0("Outputs/Output3_case9/", i, ".csv"), row.names = FALSE)