...
The "special cases" folder contains a seperate code file for generating each of the 16 special cases. It also contains the "cases.R" file which lists all 16 possible special case scenarios.
